...
public class BookDaoJdbc implements BookDao {
    ...
    private static final String FIND_BY_CATEGORY_NAME_SQL =
            "SELECT book_id, title, author, description, price, rating, is_public, is_featured, book.category_id " +
                    "FROM category, book " +
                    "WHERE category.category_id = book.category_id AND name = ? ";
    ...
    public Book findByBookId(long bookId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding book with id" + bookId, e);
        }
        return book;
    }
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books with categoryId" + categoryId, e);
        }
    ...
    public List<Book> booksByCategoryName(String categoryName) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books with categoryName" + categoryName, e);
        }
